...
export default class AddEmployee extends React.Component {
    ...
    render() {
        ...
        return <div>
            <label>姓名</label><input type="text" ref="emp_name" value={name}/>
            <label>性别</label><input type="text" ref="emp_sex" value={sex}/>
            <label>年龄</label><input type="text" ref="emp_age" value={age}/>
